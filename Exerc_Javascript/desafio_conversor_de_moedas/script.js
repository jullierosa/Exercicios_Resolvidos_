...
function converter(){
    ...
    res.innerHTML += (`E você também conseguirá comprar <b>E${respf2} euros</b> com <b>R$ ${dim},00 reais</b> que você tem na sua carteira, considerando também a cotação do euro que atualmente está a <b>E${Ceuro}euros</b>.<i>Obrigada</i>`)
}